...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% - Generated on:   11-Apr-2025 13:19:59
...
switch action
  ...
  case 'CSCDefn'
    ...
    h = Simulink.CSCDefn;
    set(h, 'Name', 'Measurement_A');
    set(h, 'OwnerPackage', 'SmartMiCSC');
    set(h, 'CSCType', 'Unstructured');
    set(h, 'MemorySection', 'MemSignal_A');
    ...
    h = Simulink.CSCDefn;
    set(h, 'Name', 'Measurement_C');
    set(h, 'OwnerPackage', 'SmartMiCSC');
    set(h, 'CSCType', 'Unstructured');
    set(h, 'MemorySection', 'MemSignal_C');
    set(h, 'IsMemorySectionInstanceSpecific', false);
    set(h, 'IsGrouped', false);
        set(h.DataUsage, 'IsParameter', false);
        set(h.DataUsage, 'IsSignal', true);
  ...
  case 'MemorySectionDefn'
    ...
    set(h, 'Name', 'MemSignal_A');
    set(h, 'OwnerPackage', 'SmartMiCSC');
    set(h, 'Comment', '');
    set(h, 'PragmaPerVar', false);
    set(h, 'PrePragma', '#define SWSMO_START_SEC_VAR_NO_INIT_UNSPECIFIED_RAM3_CYCCHK_ASILA\n#include "sws_momemmap.h"');
    set(h, 'PostPragma', '#define SWSMO_STOP_SEC_VAR_NO_INIT_UNSPECIFIED_RAM3_CYCCHK_ASILA\n#include "sws_momemmap.h"');
        set(h.DataUsage, 'IsParameter', true);
        set(h.DataUsage, 'IsSignal', true);
    set(h, 'IsConst', false);
    ...
    h = Simulink.MemorySectionDefn;
    set(h, 'Name', 'MemSignal_C');
    set(h, 'OwnerPackage', 'SmartMiCSC');
    set(h, 'Comment', '');
    set(h, 'PragmaPerVar', false);
    set(h, 'PrePragma', '#define SWSMO_START_SEC_VAR_NO_INIT_UNSPECIFIED_RAM3_CYCCHK_ASILB1\n#include "sws_momemmap.h"');
    set(h, 'PostPragma', '#define SWSMO_STOP_SEC_VAR_NO_INIT_UNSPECIFIED_RAM3_CYCCHK_ASILB1\n#include "sws_momemmap.h"');
        set(h.DataUsage, 'IsParameter', true);
        set(h.DataUsage, 'IsSignal', true);
    set(h, 'IsConst', false);
    set(h, 'IsVolatile', true);
    ...
    set(h, 'Comment', '/* ConstVolatile memory section */');
    set(h, 'PragmaPerVar', false);
    set(h, 'PrePragma', '#pragma ghs section rodata=".vcu_calibration_const"');
    set(h, 'PostPragma', '#pragma ghs section rodata=default');
        set(h.DataUsage, 'IsParameter', true);
        set(h.DataUsage, 'IsSignal', false);
    set(h, 'IsConst', true);
    set(h, 'IsVolatile', true);
