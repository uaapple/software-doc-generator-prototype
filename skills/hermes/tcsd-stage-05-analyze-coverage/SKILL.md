...
3. Derive logical mappings, AND/OR sensitization recipes, resolved comparator boundary recipes, and coverage obligations from stage 4 evidence.
4. Require machine-readable Condition, Decision, and MC/DC Coverage IR artifacts with execution-readiness counts; do not replace unresolved evidence with prose.
