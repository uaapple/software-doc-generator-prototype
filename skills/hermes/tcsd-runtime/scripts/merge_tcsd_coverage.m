function merge_tcsd_coverage(rootDir, modelName, baselineFile, candidateFile, outputDataFile, outputJson, varargin)
%MERGE_TCSD_COVERAGE Merge baseline and candidate cvdata and summarize it.
p = inputParser;
...
[~, baseline] = cvload(baselineFile, 1);
[~, candidate] = cvload(candidateFile, 1);
merged = baseline{1} + candidate{1};
