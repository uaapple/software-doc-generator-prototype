...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% - Generated on:   10-Jun-2025 10:24:38
...
switch action
  ...
  case 'CSCDefn'
    ...
    set(h, 'OwnerPackage', 'KP31Csc');
    set(h, 'CSCType', 'Unstructured');
    set(h, 'MemorySection', 'Global_Measure_8');
    set(h, 'IsMemorySectionInstanceSpecific', false);
    set(h, 'IsGrouped', false);
        set(h.DataUsage, 'IsParameter', true);
        set(h.DataUsage, 'IsSignal', true);
    ...
    h = Simulink.CSCDefn;
    set(h, 'Name', 'Global_32');
    set(h, 'OwnerPackage', 'KP31Csc');
    set(h, 'CSCType', 'Unstructured');
    set(h, 'MemorySection', 'Global_Measure_32');
    set(h, 'IsMemorySectionInstanceSpecific', false);
    set(h, 'IsGrouped', false);
        set(h.DataUsage, 'IsParameter', true);
        set(h.DataUsage, 'IsSignal', true);
  ...
  case 'MemorySectionDefn'
    ...
    h = Simulink.MemorySectionDefn;
    set(h, 'Name', 'Global_Measure_8');
    set(h, 'OwnerPackage', 'KP31Csc');
    set(h, 'Comment', '');
    set(h, 'PragmaPerVar', false);
    set(h, 'PrePragma', '#define START_SECTION_volatile_Ram0_oem_8bit\n#include "bswlib_swscoem_rb2oem.h"');
    set(h, 'PostPragma', '#define STOP_SECTION_volatile_Ram0_oem_8bit\n#include "bswlib_swscoem_rb2oem.h"');
        set(h.DataUsage, 'IsParameter', true);
        set(h.DataUsage, 'IsSignal', true);
    set(h, 'IsConst', false);
    set(h, 'IsVolatile', true);
    ...
    h = Simulink.MemorySectionDefn;
    set(h, 'Name', 'Global_Measure_32');
    set(h, 'OwnerPackage', 'KP31Csc');
    set(h, 'Comment', '');
    set(h, 'PragmaPerVar', false);
    set(h, 'PrePragma', '#define START_SECTION_volatile_Ram0_oem_32bit\n#include "bswlib_swscoem_rb2oem.h"');
    set(h, 'PostPragma', '#define STOP_SECTION_volatile_Ram0_oem_32bit\n#include "bswlib_swscoem_rb2oem.h"');
        set(h.DataUsage, 'IsParameter', true);
        set(h.DataUsage, 'IsSignal', true);
    set(h, 'IsConst', false);
    set(h, 'IsVolatile', true);
    ...
    set(h, 'Comment', '/* ConstVolatile memory section */');
    set(h, 'PragmaPerVar', false);
    set(h, 'PrePragma', '#define START_SECTION_Data_oem_8bit\n#include "bswlib_swscoem_rb2oem.h"');
    set(h, 'PostPragma', '#define STOP_SECTION_Data_oem_8bit\n#include "bswlib_swscoem_rb2oem.h"');
        set(h.DataUsage, 'IsParameter', true);
        set(h.DataUsage, 'IsSignal', false);
    set(h, 'IsConst', true);
    set(h, 'IsVolatile', true);
    ...
    set(h, 'Comment', '/* ConstVolatile memory section */');
    set(h, 'PragmaPerVar', false);
    set(h, 'PrePragma', '#define START_SECTION_Data_oem_32bit\n#include "bswlib_swscoem_rb2oem.h"');
    set(h, 'PostPragma', '#define STOP_SECTION_Data_oem_32bit\n#include "bswlib_swscoem_rb2oem.h"');
        set(h.DataUsage, 'IsParameter', true);
        set(h.DataUsage, 'IsSignal', false);
    set(h, 'IsConst', true);
    set(h, 'IsVolatile', true);
