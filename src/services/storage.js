...
export async function ensureStorage() {
  await Promise.all([
    ...
    fs.mkdir(path.dirname(config.unitTestCase?.projectRegistryPath || path.join(config.dataDir, "unit-test-case-generation", "projects.json")), { recursive: true }),
    ...
    fs.mkdir(config.skillBundleSnapshotDir, { recursive: true }),
