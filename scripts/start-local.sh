  ...
  if [[ -n "$hermes_existing_pid" ]]; then
    ...
    (
      ...
      nohup env \
        ...
        HERMES_TIMEOUT_SIMULINK_UT_TCSD_GENERATE_MS="${HERMES_TIMEOUT_SIMULINK_UT_TCSD_GENERATE_MS:-3600000}" \
        HERMES_TIMEOUT_SIMULINK_MODULE_DESCRIPTION_GENERATE_MS="${HERMES_TIMEOUT_SIMULINK_MODULE_DESCRIPTION_GENERATE_MS:-3600000}" \
        HERMES_MAX_TURNS_SIMULINK_UT_TCSD_GENERATE="${HERMES_MAX_TURNS_SIMULINK_UT_TCSD_GENERATE:-10000}" \
        ...
        UNIT_TEST_CASE_SKILL_NAME="${UNIT_TEST_CASE_SKILL_NAME:-simulink-ut-tcsd-generator}" \
        UNIT_TEST_CASE_EXPECTED_OUTPUT_PATTERN="${UNIT_TEST_CASE_EXPECTED_OUTPUT_PATTERN:-outputs/*_tcsd.xlsx}" \
        SOFTWARE_MODULE_DESCRIPTION_SKILL_NAME="${SOFTWARE_MODULE_DESCRIPTION_SKILL_NAME:-simulink-module-description-generator}" \
        SOFTWARE_MODULE_DESCRIPTION_EXPECTED_OUTPUT_PATTERN="${SOFTWARE_MODULE_DESCRIPTION_EXPECTED_OUTPUT_PATTERN:-outputs/*.docx}" \
        SOFTWARE_MODULE_DESCRIPTION_AGENT_WORKSPACE_ROOT="${SOFTWARE_MODULE_DESCRIPTION_AGENT_WORKSPACE_ROOT:-${UNIT_TEST_CASE_AGENT_WORKSPACE_ROOT:-}}" \
