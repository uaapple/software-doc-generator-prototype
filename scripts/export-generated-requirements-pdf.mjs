...
const inputHtml = path.join(rootDir, 'docs', 'generated-requirements-overview.html');
const outputDir = path.join(rootDir, 'output', 'pdf');
const outputPdf = path.join(outputDir, '项目生成软件需求整理.pdf');
...
async function resolveBrowserPath() {
  ...
  throw new Error('未找到可用浏览器，无法导出 PDF。');
}
